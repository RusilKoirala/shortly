  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center bg-black font-geist">
      ...
      <div className="bg-zinc-900 rounded-2xl shadow-2xl p-8 w-full max-w-md animate-fadein">
        <h2 className="text-3xl font-bold mb-6 text-center font-satoshi text-white">Create your account</h2>
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-2 font-inter">Username</label>
            <input
              type="text"
              name="name"
              value={form.name}
